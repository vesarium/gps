 ...
 */
final class Version20190707233741 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE devices (id INT NOT NULL, device_name TEXT DEFAULT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
